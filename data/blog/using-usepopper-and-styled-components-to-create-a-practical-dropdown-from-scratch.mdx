...
title: Using usePopper and styled-components to create a practical dropdown from
  scratch
date: '2021-03-06'
tags: ['development', 'components', 'styled-components']
draft: false
summary: 'Creating a dropdown from scratch using popper.js and styled components.'
---
...
_borrowed straight from docs [example](https://popper.js.org/react-popper/v2/#example)_
...
<iframe
  src="https://codesandbox.io/embed/1-react-popper-vanilla-mnm2b?fontsize=14&hidenavigation=1&theme=dark"
...
<iframe
  src="https://codesandbox.io/embed/2-react-popper-docs-dropdown-19kxt?fontsize=14&hidenavigation=1&theme=dark"
  style={{ width: '100%', height: '500px', border: 0, borderRadius: '4px', overflow: 'hidden' }}
...
<iframe
  src="https://codesandbox.io/embed/3-react-popper-realistic-dropdown-yun1q?fontsize=14&hidenavigation=1&theme=dark"
  style={{ width: '100%', height: '500px', border: 0, borderRadius: '4px', overflow: 'hidden' }}
